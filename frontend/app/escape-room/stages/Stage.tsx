...
export default function Stage({ onEnterRoom }: StageProps) {
  ...
  const handleStartTimer = () => {
    return trace
      ...
      .startActiveSpan('start-escape-room', async (span) => {
        try {
          let timerSeconds = 0;
          ...
          span.setAttributes({
            'timer.selected': timerSeconds,
            'timer.type': selectedTimer ? 'preset' : 'custom'
          });

          onEnterRoom(timerSeconds);
        } catch (error) {
          span.setStatus({ code: 2, message: 'Failed to start timer' });
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ marginBottom: '20px' }}>
            After exploring the dense forests, you finally see the cave entrance. 
            Ancient symbols are carved into the stone walls, glowing faintly in the darkness.
          </p>
          <p style={{ marginBottom: '20px' }}>
            As you step inside, you notice the treasure chest in the corner. 
            It&apos;s locked with multiple mechanisms, and there&apos;s an inscription that reads:
          </p>
          <p style={{
            fontStyle: 'italic',
            fontSize: '1.1rem',
            ...
            &quot;The true treasure lies outside the vessel, the one inside is earned. 
            Open me if you are meant to be the chosen one...&quot;
          </p>
        </div>
      </div>
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '12px' }}>
            <p style={{
              ...
              Or enter custom time (1-15 minutes):
            </p>
